...
import xLogoImage from './assets/X.png';
...
const Header = ({ scrolled }) => {
    ...
    return (
        <header className={`header ${scrolled ? 'scrolled' : ''}`}>
            <div className="logo">
                <img src={jenekoLogo} alt="JENEKO Logo" className="logo-img" />
                <span className="logo-text">JENEKO</span>
            </div>
            
            <nav className={`nav-links ${isMenuOpen ? 'mobile-open' : ''}`}>
                <a href="#hero-section" onClick={toggleMenu}>Home</a>
                <a href="#personal-projects" onClick={toggleMenu}>Work</a>
                <a href="#client-commissions" onClick={toggleMenu}>Commissions</a>
...
const SocialLinks = () => ( <section className="social-links"> <div className="container"> <h2>Find Me On</h2> <p>Connect with me across different platforms</p> <div className="social-icons"> <a href="https://www.instagram.com/_jeneko/" target="_blank" rel="noopener noreferrer" className="social-icon-item"> <InstagramIcon /> <span>Instagram</span> </a> <a href="https://x.com/_Jeneko" target="_blank" rel="noopener noreferrer" className="social-icon-item"> <img src={xLogoImage} alt="X Logo" /> <span>Twitter</span> </a> <a href="https://www.fiverr.com/sellers/jenart410/edit" target="_blank" rel="noopener noreferrer" className="social-icon-item"> <img src={fiverrIconImg} alt="Fiverr" /> <span>Fiverr</span> </a> </div> </div> </section> );
...
const Contact = () => ( <section className="contact" id="contact-section"> <h2>Let's Connect</h2> <p>Ready to bring your vision to life? Get in touch!</p> <div className="contact-grid"> <div className="contact-card"> <svg fill="white" viewBox="0 0 16 16"><path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/></svg> <span>Location</span> <a href="#">India</a> </div> <div className="contact-card"> <svg fill="white" viewBox="0 0 16 16"><path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/></svg> <span>Email</span> <a href="mailto:jen.art410@gmail.com">jen.art410@gmail.com</a> </div> <div className="contact-card"> <InstagramIcon /> <span>Instagram</span> <a href="https://www.instagram.com/_jeneko/" target="_blank" rel="noopener noreferrer">@_jeneko</a> </div> <div className="contact-card"> <img src={xLogoImage} alt="X Logo" className="footer-x-icon" /> <span>Twitter</span> <a href="https://x.com/_Jeneko" target="_blank" rel="noopener noreferrer">@_jeneko</a> </div> </div> </section> );
